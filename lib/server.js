...
/*
    helpers.sendTwillioSms('5296533196','Hello diar friend',(err)=>{
        console.log(`this was an error ${err}`);
    });
*/ 
// TESTING
// // @TODO DELETE THIS
// _data.create('test','newFile',{"foo":'bar','bar':'bizz'},(err)=>{
//     console.log('this was the error',err);
// });
//_data.getPath((path)=>{console.log(path)});    
//instant HTTP server
 ...
 server.unifiedServer = function(req,res){
    ...
    req.on('end', function() {
        ...
        chosenHandler(data,function(statusCode,payload,contentType){
          ...
          //Determine the tipe of response
 ...
 server.router = {
    ...
    'session/create' : handlers.sesionCreate,
